...
public class ScroolingTabsActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_scrollingtabs);
        findView();
        initView();
    }
    ...
    private void initView() {
        ...
        mScrollingTabs.setTabAdapter(new TabAdapter() {
            ...
            public View getView(int position) {
                LayoutInflater inflater = ScroolingTabsActivity.this.getLayoutInflater();
            ...
            public View getSeparator() {
                View view = new ImageView(ScroolingTabsActivity.this);
